...
export const SITE_URL = 'https://vfx-portfolio-ecru.vercel.app';
...
// `contexts` maps each skill to the Houdini node-context badge(s) it belongs
// under (SOPs/DOPs/VOPs/POPs/ROPs/TOPs/LOPs) — used to power the VFX ARSENAL filters.
export const skills = [
    { id: 'pyro', title: 'Pyro FX', desc: 'Fire, smoke, explosions and volumetrics', icon: '🔥', theme: 'orange', image_url: '/media/smoke-comp-liveaction.jpg', contexts: ['DOPs', 'VOPs'] },
    { id: 'rbd', title: 'RBD / Destruction', desc: 'Fracturing, rigid bodies, debris and dust', icon: '💥', theme: 'red', image_url: '/media/car-destruction-rbd.jpg', contexts: ['DOPs', 'SOPs'] },
    { id: 'flip', title: 'FLIP Fluids', desc: 'Water, splashes, oceans and whitewater', icon: '🌊', theme: 'blue', image_url: '', contexts: ['DOPs'] },
    { id: 'particles', title: 'Particles / POPs', desc: 'Fireworks, sparks, magic and energy FX', icon: '✨', theme: 'cyan', image_url: '/media/fireworks-particles.jpg', contexts: ['POPs', 'DOPs'] },
    { id: 'vellum', title: 'Vellum Cloth', desc: 'Cloth, flags, soft bodies', icon: '🧵', theme: 'purple', image_url: '/media/flag-cloth-sim.jpg', contexts: ['DOPs'] },
    { id: 'crowds', title: 'Crowd Sim', desc: 'Agent crowds for stadiums, streets and battles', icon: '🏟️', theme: 'green', image_url: '/media/crowd-sim-stadium.jpg', contexts: ['SOPs', 'DOPs'] },
    { id: 'karma', title: 'Lighting & Karma', desc: 'Look-dev, lighting and rendering in Solaris', icon: '💡', theme: 'gold', image_url: '/media/magic-particle-burst.jpg', contexts: ['LOPs', 'ROPs', 'VOPs'] },
    { id: 'comp', title: 'Compositing (Nuke)', desc: 'Integrating CG FX into live-action plates', icon: '🎬', theme: 'techGrey', image_url: '/media/smoke-comp-liveaction.jpg', contexts: ['TOPs'] },
];

// The Houdini context badges shown under the VFX ARSENAL heading — order matters.
export const houdiniOps = ['SOPs', 'DOPs', 'VOPs', 'POPs', 'ROPs', 'TOPs', 'LOPs'];
...
// `skillId` links each service to its matching entry in `skills` — clicking a
// service card takes the visitor into that skill's page in the VFX ARSENAL.
export const services = [
    { id: 1, title: 'Pyro & Explosions', desc: 'Fire, smoke and explosion simulations for cinematic shots, from small practical-style bursts to large-scale events.', icon: '🔥', skillId: 'pyro' },
    { id: 2, title: 'RBD Destruction', desc: 'Procedural fracturing and rigid-body dynamics — buildings, vehicles, props — with debris and dust passes.', icon: '💥', skillId: 'rbd' },
    { id: 3, title: 'FLIP Fluids & Oceans', desc: 'Water, splashes, oceans and whitewater using Houdini\'s FLIP and ocean toolsets.', icon: '🌊', skillId: 'flip' },
    { id: 4, title: 'Particle & Magic FX', desc: 'Fireworks, sparks, energy and stylised magic elements built in POPs, delivered as comp-ready passes.', icon: '✨', skillId: 'particles' },
    { id: 5, title: 'Cloth & Soft Bodies', desc: 'Vellum cloth, flags, banners and soft-body simulation for hero and background assets.', icon: '🧵', skillId: 'vellum' },
    { id: 6, title: 'Lighting & Rendering', desc: 'Look-dev, lighting and rendering of FX in Karma / Solaris with AOVs for compositing.', icon: '💡', skillId: 'karma' },
    { id: 7, title: 'Compositing & Integration', desc: 'Integrating CG effects into live-action footage in Nuke — matching light, grain and camera.', icon: '🎬', skillId: 'comp' },
    { id: 8, title: 'Full-Shot FX Vendor', desc: 'End-to-end FX shots for film, series and advertising through Nova FX Studios, Kigali.', icon: '🎥', skillId: null },
];
